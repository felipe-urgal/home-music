...
MOCK
  ...
  unset MOCK_TS_VERSION MOCK_STATUS_FAIL MOCK_FAIL_SERVE MOCK_FAIL_FUNNEL MOCK_FAIL_ACTIVE MOCK_FAIL_RESTART MOCK_FAIL_CURL MOCK_FAIL_PUBLIC_CURL
}

cleanup_fixture() {
  rm -rf "${FIXTURE}"
  export PATH="${ORIGINAL_PATH}"
  unset HOME_MUSIC_FUNNEL_YES MOCK_STATE MOCK_TS_VERSION MOCK_STATUS_FAIL MOCK_FAIL_SERVE MOCK_FAIL_FUNNEL MOCK_FAIL_ACTIVE MOCK_FAIL_RESTART MOCK_FAIL_CURL MOCK_FAIL_PUBLIC_CURL
}
