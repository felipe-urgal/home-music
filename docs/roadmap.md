...
> Estado revisado em 2026-09-01. O PR #204/#119 foi mergeado; a #120 é a atividade técnica atual da Fase 11 e está em implementação na branch `feature/accessibility-review`. Itens marcados como concluídos refletem funcionalidades já entregues; itens futuros apontam para a issue que mantém escopo e gate atualizados.
...
- [ ] [#120](https://github.com/felipe-urgal/home-music/issues/120) — revisão sistemática de acessibilidade em implementação na branch `feature/accessibility-review`;
...
A #120 trata acessibilidade como contrato funcional. A implementação corrente consolida foco visível global, movimento reduzido/forced colors, associação de erros de autenticação, estados correntes da Biblioteca, estado de repeat e feedback de reordenação da fila, acompanhados de regressões Vitest e Playwright mobile/tablet/desktop. Detalhes e limites: [accessibility.md](accessibility.md).

**Ordem técnica atual:** a #120 é a atividade em execução. Após seu merge, a próxima atividade da Fase 11 é a #121; #122 permanece na sequência, salvo repriorização explícita registrada em #123 e neste roadmap.
...
As pendências executivas abertas são #81, #120–#123 e #174–#176. A #123 é somente o índice executivo; as implementações/validações reais são #81, #120–#122 e #174–#176.
