...
- **Fase 15 — Library Assistant:** fase ativa, coordenada pela issue #310. A fundação #311, a identificação de metadata com MusicBrainz #312, a revisão/aplicação segura #313, artwork via Cover Art Archive #314, lyrics operacionais via LRCLIB #315, a operação em volume #356, a normalização assistida por evidência MusicBrainz #319 e a identificação opcional por áudio #320 estão implementadas/documentadas nos documentos canônicos da fase.
...
### Base estabilizada (#311 + #312 + #313 + #314 + #315 + #319 + #320 + #356)
