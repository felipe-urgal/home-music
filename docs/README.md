...
> Inventário e backlog revisados em 2026-09-01. O PR #204 concluiu a #119; a revisão sistemática de acessibilidade da #120 está em andamento na branch `feature/accessibility-review`. Documentos históricos são preservados como registro; o estado de entrega deve ser lido neste índice, em `roadmap.md`, na issue executiva #123 e nas issues abertas.
...
| --- | --- |
| [#120](https://github.com/felipe-urgal/home-music/issues/120) | atividade técnica atual da Fase 11: revisão sistemática de acessibilidade em implementação na branch `feature/accessibility-review` |
